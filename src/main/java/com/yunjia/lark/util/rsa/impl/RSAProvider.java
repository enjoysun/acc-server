package com.yunjia.lark.util.rsa.impl;

import com.yunjia.lark.util.rsa.AsymmetryService;
...
/**
 * @Author myou
 * @Date 2021/3/17  4:16 下午
 *
 * 非对称加密RSA
 */
public class RSAProvider implements AsymmetryService {
...
//        String publicKeyStr = Base64.encodeBase64URLSafeString(publicKey.getEncoded());
    ...
    public static void main (String[] args) throws Exception {
        Map<String, String> keyMap = RSAProvider.createKeys(1024);
        ...
        String str = "myouming87000@qwe";
        System.out.println("\r明文：\r\n" + str);
        System.out.println("\r明文大小：\r\n" + str.getBytes().length);
        String encodedData = RSAProvider.publicEncrypt(str, RSAProvider.getPublicKey(publicKey));
        System.out.println("密文：\r\n" + encodedData);
        String decodedData = RSAProvider.privateDecrypt(encodedData, RSAProvider.getPrivateKey(privateKey));

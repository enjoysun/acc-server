CREATE TABLE `organization` (
  ...
  `updated_by` varchar(16) NOT NULL comment '修改人',
...
CREATE TABLE `department` (
  ...
  `org_id` bigint unsigned comment '所属组织',
  `created_by` varchar(16) NOT NULL comment '创建人',
  `updated_by` varchar(16) NOT NULL comment '修改人',
  `ctime` datetime default current_timestamp comment '创建时间',
  `utime` datetime default current_timestamp on update current_timestamp comment '更新时间',
...
CREATE TABLE `user` (
  ...
  `dpt_id` bigint unsigned comment '所属部门',
  `created_by` varchar(16) NOT NULL comment '创建人',
  `updated_by` varchar(16) NOT NULL comment '修改人',
  `ctime` datetime default current_timestamp comment '创建时间',
  `utime` datetime default current_timestamp on update current_timestamp comment '更新时间',
...
CREATE TABLE `role` (
  ...
  `pid` bigint unsigned default 0 COMMENT '父角色id',
...
CREATE TABLE `menu` (
  ...
  `pid` bigint unsigned comment '父菜单id',
  `created_by` varchar(16) NOT NULL comment '创建人',
  `updated_by` varchar(16) NOT NULL comment '修改人',
  `ctime` datetime default current_timestamp comment '创建时间',
  `utime` datetime default current_timestamp on update current_timestamp comment '更新时间',
